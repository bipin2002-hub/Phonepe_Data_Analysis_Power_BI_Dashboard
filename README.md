...
Open PhonePe_UPI_Dashboard.pbix in Power BI Desktop.
If prompted, update the data source path to point to your local dataset.
Use the slicers on the left panel to filter by Age Group, City, Gender, Merchant, Payment Mode, and more.
📊 Dataset
